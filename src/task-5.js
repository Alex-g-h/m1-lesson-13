...
class JuniorDeveloper extends Developer {
  constructor(fullName, age) {
    ...
    this.learnNewTechnologies('HTML');
    this.learnNewTechnologies('CSS');
    this.learnNewTechnologies('JavaScript');
  }
...
class MiddleDeveloper extends Developer {
  constructor(fullName, age) {
    ...
    this.learnNewTechnologies('CSS');
    this.learnNewTechnologies('JavaScript');
    this.learnNewTechnologies('React');
  }
...
class SeniorDeveloper extends Developer {
  constructor(fullName, age) {
    ...
    this.learnNewTechnologies('JavaScript');
    this.learnNewTechnologies('React');
    this.learnNewTechnologies('NodeJS');
  }
